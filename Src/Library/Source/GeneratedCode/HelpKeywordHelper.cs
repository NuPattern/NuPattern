...
namespace Microsoft.VisualStudio.Patterning.Library.Automation
{
	...
	/// </remarks>
	internal partial class LibraryHelpKeywordHelper : LibraryHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new LibraryHelpKeywordHelper.
		/// </summary>
		protected LibraryHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the LibraryHelpKeywordHelper.
		/// </summary>
		public static LibraryHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	internal abstract class LibraryHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new LibraryHelpKeywordHelperBase.
		/// </summary>
		protected LibraryHelpKeywordHelperBase()
			: base() { }
