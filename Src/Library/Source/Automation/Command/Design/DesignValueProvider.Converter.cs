...
namespace NuPattern.Library.Automation
{
	...
	{
		static IEnumerable<Lazy<Microsoft.VisualStudio.TeamArchitect.PowerTools.Features.IValueProvider, IFeatureComponentMetadata>> ValueProviders { get; set; }
		...
		public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
		{
			if (destinationType == typeof(string))
			{
				...
				var provider = value as DesignValueProvider;
				if (provider != null)
				{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			...
			var valueProviderName = value as string;
			return string.IsNullOrEmpty(valueProviderName) ? null : new DesignValueProvider((DesignProperty)context.Instance, valueProviderName);
		}
			...
			get
			{
				if (standardValues == null)
				{
					...
					var types = ProjectTypeProvider
						.GetTypes<Microsoft.VisualStudio.TeamArchitect.PowerTools.Features.IValueProvider>()
