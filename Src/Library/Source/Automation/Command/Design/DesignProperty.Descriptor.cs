...
namespace NuPattern.Library.Automation
{
    ...
    public class DesignPropertyDescriptor : PropertyDescriptor
    {
        ...
        {
            var modelProperty = EnsurePropertySettings(component, this.Name, this.PropertyType);
        ...
        /// <summary>
        /// Ensures the property settings exist. If not then create them.
        /// </summary>
        internal static PropertySettings EnsurePropertySettings(object component, string propertyName, Type PropertyType)
        {
            ...
            var modelProperty = element.Properties.FirstOrDefault(prop => prop.Name == propertyName);
            if (modelProperty == null)
            {
                using (var tx = element.Store.TransactionManager.BeginTransaction("Creating Property"))
                {
                    ...
                    if (PropertyType.IsValueType)
                    {
                        ...
                        modelProperty.Value = Activator.CreateInstance(PropertyType).ToString();
                    }
