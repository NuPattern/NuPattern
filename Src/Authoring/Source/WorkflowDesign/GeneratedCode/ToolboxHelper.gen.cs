...
namespace Microsoft.VisualStudio.Patterning.Authoring.WorkflowDesign
{
	...
	public partial class WorkflowDesignToolboxHelper : WorkflowDesignToolboxHelperBase 
	{
		...
		/// </summary>
		public WorkflowDesignToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class WorkflowDesignToolboxHelperBase
	{
		...
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "WorkflowDesign.1.2";
		/// <summary>
		/// Toolbox item filter string used to identify SuppliedAsset element tool.
		/// </summary>
		public const string SuppliedAssetFilterString = "SuppliedAsset.1.2";
		/// <summary>
		/// Toolbox item filter string used to identify ProductionTool element tool.
		/// </summary>
		public const string ProductionToolFilterString = "ProductionTool.1.2";
		/// <summary>
		/// Toolbox item filter string used to identify ProducedAsset element tool.
		/// </summary>
		public const string ProducedAssetFilterString = "ProducedAsset.1.2";
		/// <summary>
		/// Toolbox item filter string used to identify ProductionWorkflowConnector connector tool.
		/// </summary>
		public const string ProductionWorkflowConnectorFilterString = "ProductionWorkflowConnector.1.2";
		...
		/// <summary>
		/// Constructs a new WorkflowDesignToolboxHelperBase.
		/// </summary>
		protected WorkflowDesignToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
