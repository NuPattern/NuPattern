...
namespace Microsoft.VisualStudio.Patterning.Authoring.Authoring
{
    ...
    public partial class AuthoringPackage : Package
    {
        ...
        private static string MsBuildPath = @"%localappdata%\Microsoft\MSBuild\Outercurve\Pattern Toolkit Builder VS2010";
		private static string TargetsFilename = "Microsoft.VisualStudio.Patterning.Authoring.PatternToolkitVersion.gen.targets";
