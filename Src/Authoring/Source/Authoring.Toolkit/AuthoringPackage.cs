...
namespace Microsoft.VisualStudio.Patterning.Authoring.Authoring
{
    ...
    public class AuthoringPackage : Package
    {
        ...
        internal static string CurrentToolkitVersion = "1.2.19.0";
        internal static string MsBuildPath = @"%localappdata%\Microsoft\MSBuild\Microsoft\Pattern Toolkit Builder";
