...
namespace Microsoft.VisualStudio.Patterning.Authoring.Library
{
	...
	{ 
		...
		/// <summary>
		///	Creates a new <see cref="ICommands"/> and adds it to the <see cref="Commands"/> 
		...
		/// <summary>
		///	Creates a new <see cref="IConditions"/> and adds it to the <see cref="Conditions"/> 
		///	collection, executing the optional <paramref name="initializer"/> if not <see langword="null"/>.
		///	</summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed")]
		...
		/// <summary>
		///	Creates a new <see cref="IEvents"/> and adds it to the <see cref="Events"/> 
		///	collection, executing the optional <paramref name="initializer"/> if not <see langword="null"/>.
		///	</summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed")]
		...
		/// <summary>
		///	Creates a new <see cref="ITypeConverters"/> and adds it to the <see cref="TypeConverters"/> 
		///	collection, executing the optional <paramref name="initializer"/> if not <see langword="null"/>.
		///	</summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed")]
		...
		/// <summary>
		///	Creates a new <see cref="ITypeEditors"/> and adds it to the <see cref="TypeEditors"/> 
		///	collection, executing the optional <paramref name="initializer"/> if not <see langword="null"/>.
		///	</summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed")]
		...
		/// <summary>
		///	Creates a new <see cref="IValidationRules"/> and adds it to the <see cref="ValidationRules"/> 
		///	collection, executing the optional <paramref name="initializer"/> if not <see langword="null"/>.
		///	</summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed")]
		...
		/// <summary>
		///	Creates a new <see cref="IValueProviders"/> and adds it to the <see cref="ValueProviders"/> 
		///	collection, executing the optional <paramref name="initializer"/> if not <see langword="null"/>.
		///	</summary>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed")]
