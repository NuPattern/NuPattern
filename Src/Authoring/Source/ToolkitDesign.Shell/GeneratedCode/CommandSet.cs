...
namespace Microsoft.VisualStudio.Patterning.Runtime.Schema
{
	...
	/// </summary>
	internal partial class PatternModelCommandSet : PatternModelCommandSetBase
	{
		/// <summary>
		/// Constructs a new PatternModelCommandSet.
		/// </summary>
		public PatternModelCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PatternModelCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PatternModelCommandSetBase.
		/// </summary>
		protected PatternModelCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		{
			if (this.CurrentPatternModelDocData != null && this.CurrentPatternModelDocData.Store != null)
			{
				this.CurrentPatternModelDocData.ValidationController.Validate(this.CurrentPatternModelDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentPatternModelDocData != null && this.CurrentPatternModelDocData.Store != null)
			{
				...
				this.CurrentPatternModelDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected PatternModelDocData CurrentPatternModelDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PatternModelDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PatternModelDocView CurrentPatternModelDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PatternModelDocView;
			}
		}
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PatternModelClipboardCommandSet : PatternModelClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PatternModelClipboardCommandSet.
		/// </summary>
		public PatternModelClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PatternModelClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PatternModelClipboardCommandSetBase.
		/// </summary>
		protected PatternModelClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
