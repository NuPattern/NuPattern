...
namespace NuPattern.Authoring.PatternToolkitLibrary
{
	...
	internal partial class Conditions : IConditions
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IConditions> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="Conditions"/> class.
		/// </summary>
		[ImportingConstructor]
		private Conditions() { }
...
namespace NuPattern.Authoring.PatternToolkitLibrary
{
	...
	internal partial class TypeConverters : ITypeConverters
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<ITypeConverters> proxy;
...
namespace NuPattern.Authoring.PatternToolkitLibrary
{
	...
	internal partial class TypeEditors : ITypeEditors
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<ITypeEditors> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="TypeEditors"/> class.
		/// </summary>
		[ImportingConstructor]
		private TypeEditors() { }
...
namespace NuPattern.Authoring.PatternToolkitLibrary
{
	...
	internal partial class ValidationRules : IValidationRules
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IValidationRules> proxy;
...
namespace NuPattern.Authoring.PatternToolkitLibrary
{
	...
	internal partial class ValueProviders : IValueProviders
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IValueProviders> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="ValueProviders"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkitLibrary
{
	...
	internal partial class ValueComparers : IValueComparers
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IValueComparers> proxy;
