...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class ItemTemplate : IItemTemplate
	{
		...
		private IAbstractElementProxy<IItemTemplate> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="ItemTemplate"/> class.
		/// </summary>
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class ProjectTemplate : IProjectTemplate
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IProjectTemplate> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="ProjectTemplate"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class TextTemplate : ITextTemplate
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<ITextTemplate> proxy;
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class Wizard : IWizard
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IWizard> proxy;
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class WizardPage : IWizardPage
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IWizardPage> proxy;
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class Guidance : IGuidance
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IGuidance> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="Guidance"/> class.
		/// </summary>
		[ImportingConstructor]
		private Guidance() { }
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class PatternModel : IPatternModel
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IPatternModel> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="PatternModel"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class ViewModel : IViewModel
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IViewModel> proxy;
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class PatternToolkitInfo : IPatternToolkitInfo
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IPatternToolkitInfo> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="PatternToolkitInfo"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class ProductionTooling : IProductionTooling
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IProductionTooling> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="ProductionTooling"/> class.
		/// </summary>
		[ImportingConstructor]
