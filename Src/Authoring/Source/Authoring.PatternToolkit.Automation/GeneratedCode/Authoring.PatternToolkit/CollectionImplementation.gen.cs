...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class Assets : IAssets
	{
		...
		private IAbstractElementProxy<IAssets> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="Assets"/> class.
		/// </summary>
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class Templates : ITemplates
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<ITemplates> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="Templates"/> class.
		/// </summary>
		[ImportingConstructor]
		private Templates() { }
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class ItemTemplates : IItemTemplates
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IItemTemplates> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="ItemTemplates"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class ProjectTemplates : IProjectTemplates
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IProjectTemplates> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="ProjectTemplates"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class TextTemplates : ITextTemplates
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<ITextTemplates> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="TextTemplates"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class Wizards : IWizards
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IWizards> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="Wizards"/> class.
		/// </summary>
		[ImportingConstructor]
		private Wizards() { }
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class WizardPages : IWizardPages
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IWizardPages> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="WizardPages"/> class.
		/// </summary>
		[ImportingConstructor]
		private WizardPages() { }
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class AutomationCollection : IAutomationCollection
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IAutomationCollection> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="AutomationCollection"/> class.
		/// </summary>
		[ImportingConstructor]
...
namespace NuPattern.Authoring.PatternToolkit
{
	...
	internal partial class Views : IViews
	{
		...
		private Runtime.IAbstractElement target;
		private IAbstractElementProxy<IViews> proxy;

		/// <summary>
		/// Creates a new instance of the <see cref="Views"/> class.
		/// </summary>
		[ImportingConstructor]
		private Views() { }
