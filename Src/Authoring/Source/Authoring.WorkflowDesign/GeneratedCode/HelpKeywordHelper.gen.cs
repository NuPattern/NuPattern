...
namespace NuPattern.Authoring.WorkflowDesign
{
	...
	public partial class WorkflowDesignHelpKeywordHelper : WorkflowDesignHelpKeywordHelperBase 
	{
		...
		/// <summary>
		/// Constructs a new WorkflowDesignHelpKeywordHelper.
		/// </summary>
		protected WorkflowDesignHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the WorkflowDesignHelpKeywordHelper.
		/// </summary>
		public static WorkflowDesignHelpKeywordHelper Instance
		{
			get
			{
	...
	public abstract class WorkflowDesignHelpKeywordHelperBase
	{
		...
		/// <summary>
		/// Constructs a new WorkflowDesignHelpKeywordHelperBase.
		/// </summary>
		protected WorkflowDesignHelpKeywordHelperBase()
			: base() { }
