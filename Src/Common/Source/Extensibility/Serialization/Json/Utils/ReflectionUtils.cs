...
namespace Microsoft.VisualStudio.Patterning.Extensibility.Serialization.Json
{
    internal static class ReflectionUtils
    {
        ...
        public static bool ImplementsGenericDefinition(Type type, Type genericInterfaceDefinition, out Type implementingType)
        {
            ...
            Guard.NotNull(() => genericInterfaceDefinition, genericInterfaceDefinition);
        ...
        {
            Guard.NotNull(() => type, type);
            Guard.NotNull(() => genericClassDefinition, genericClassDefinition);
        ...
        {
            Guard.NotNull(() => dictionaryType, dictionaryType);
        ...
        {
            Guard.NotNull(() => genericTypeDefinition, genericTypeDefinition);
            Guard.NotNull(() => innerTypes, innerTypes);
            if (!genericTypeDefinition.IsGenericTypeDefinition)
                throw new ArgumentException("genericTypeDefinition", "Type {0} is not a generic type definition.".FormatWith(CultureInfo.InvariantCulture, genericTypeDefinition));
        ...
        public static object CreateGeneric(Type genericTypeDefinition, IList<Type> innerTypes, Func<Type, IList<object>, object> instanceCreator, params object[] args)
        {
            Guard.NotNull(() => genericTypeDefinition, genericTypeDefinition);
            Guard.NotNull(() => innerTypes, innerTypes);
            Guard.NotNull(() => instanceCreator, instanceCreator);
