...
namespace NuPattern.Extensibility.Binding
{
        ...
        where TInstance : class
    {
        ...
        /// </summary>
        [CLSCompliant(false)]
        public static IEnumerable<PropertyDescriptor> GetComponentProperties(IPlatuProjectTypeProvider provider, IEnumerable<Lazy<TComponents, IFeatureComponentMetadata>> components, string extensionName)
        {
        ...
        private static Type GetExtensionType(IPlatuProjectTypeProvider provider, IEnumerable<Lazy<TComponents, IFeatureComponentMetadata>> components, string extensionName)
        {
            if (string.IsNullOrEmpty(extensionName))
            {
                return null;
