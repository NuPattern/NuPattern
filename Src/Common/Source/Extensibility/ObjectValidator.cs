...
namespace NuPattern.Extensibility
{
    ...
    public static class ObjectValidator
    {
        ...
        public static void ThrowIfInvalid(object component)
        {
            ...
            if (results.Any())
            {
                ...
                var message = results.Aggregate(
                    string.Format(Resources.Culture, Resources.ValidationException, component),
        ...
        {
            return validation.FormatErrorMessage(displayName) ?? string.Format(Resources.Culture, Resources.ValidatorDefaultMessage, validation.GetType().Name);
        }
    }
}