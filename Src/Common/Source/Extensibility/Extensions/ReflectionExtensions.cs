...
namespace Microsoft.VisualStudio.Patterning.Extensibility
{
	...
	public static class ReflectionExtensions
	{
		...
		{
			return Reflector<T>.GetProperty<TResult>(property);
		}
		...
		public static string Category(this ICustomAttributeProvider provider, bool inherit /* = true */)
		{
			var attribute = GetCustomAttribute<CategoryAttribute>(provider, inherit);
			if (attribute != null)
			{
