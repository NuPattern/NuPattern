    ...
    public sealed class ImageFilterAttribute : Attribute
    {
            ...
            get
            {
                switch (this.kind)
                {
                    case ImageKind.Image:
                        return Resources.SelectImage;
                    case ImageKind.Bitmap:
                        return Resources.SelectBitmap;
                    case ImageKind.Icon:
                        return Resources.SelectIcon;
                    default:
                        return Resources.SelectImage;
                }
            }
        ...
        public string FileFilter
        {
            get
            {
                ...
                {
                    case ImageKind.Image:
                        return Resources.ImageFilter;
                    case ImageKind.Bitmap:
                        return Resources.BitmapFilter;
                    case ImageKind.Icon:
                        return Resources.IconFilter;
                    default:
                        return Resources.ImageFilter;
                }
            }
