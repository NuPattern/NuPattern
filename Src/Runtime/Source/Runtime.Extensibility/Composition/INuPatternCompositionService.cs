...
{
    /// <summary>
    /// Main interface that allows guidance extension to create additional components 
    /// it may need for its operation, that integrate seamlessly with 
    /// the composition infrastructure of the runtime and 
    /// Visual Studio.
    /// </summary>
    public interface INuPatternCompositionService : ICompositionService, IDisposable
    {
        /// <summary>
