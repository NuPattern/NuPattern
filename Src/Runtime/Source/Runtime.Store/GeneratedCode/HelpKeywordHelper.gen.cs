...
namespace Microsoft.VisualStudio.Patterning.Runtime.Store
{
	...
	public partial class ProductStateStoreHelpKeywordHelper : ProductStateStoreHelpKeywordHelperBase 
	{
		...
		/// <summary>
		/// Constructs a new ProductStateStoreHelpKeywordHelper.
		/// </summary>
		protected ProductStateStoreHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ProductStateStoreHelpKeywordHelper.
		/// </summary>
		public static ProductStateStoreHelpKeywordHelper Instance
		{
			get
			{
	...
	public abstract class ProductStateStoreHelpKeywordHelperBase
	{
		...
		/// <summary>
		/// Constructs a new ProductStateStoreHelpKeywordHelperBase.
		/// </summary>
		protected ProductStateStoreHelpKeywordHelperBase()
			: base() { }
