...
namespace NuPattern.Runtime.Store
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides ProductStateStore files
	/// The implementation is done in ProductStateStoreDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class ProductStateStoreDirectiveProcessor : ProductStateStoreDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public ProductStateStoreDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides ProductStateStore files
	/// </summary>
	public class ProductStateStoreDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string ProductStateStoreDirectiveProcessorName = "ProductStateStoreDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "ProductState";
		...
		/// </summary>
		private const string supportedDirectiveName = "ProductStateStore";
		...
		/// Constructor
		/// </summary>
		public ProductStateStoreDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return ProductStateStoreDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(IProductState));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(IProductState));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "ProductState" + "RelativePathToTemplateRelativePath";
						...
						global::System.CodeDom.CodeExpressionStatement addModel = new global::System.CodeDom.CodeExpressionStatement(
							new global::System.CodeDom.CodeMethodInvokeExpression(
								...
								new global::System.CodeDom.CodePropertyReferenceExpression(
									new global::System.CodeDom.CodeTypeReferenceExpression(typeof(ProductStateModelReader)), 
									"DomainModelType")));
			...
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				if (languageProvider != null)
				{
					...
					invokeLoad = new global::System.CodeDom.CodeMethodInvokeExpression(
						new global::System.CodeDom.CodeMethodReferenceExpression(
							new global::System.CodeDom.CodeTypeReferenceExpression(typeof(ProductStateModelReader)), "Read"),
							new global::System.CodeDom.CodeVariableReferenceExpression("serializationResult"), 
							new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"), 
							new global::System.CodeDom.CodePrimitiveExpression(requiresArguments[requiresFileParameter]));
		...
		public override string[] GetReferencesForProcessingRun()
		{
			...
			references.Add(System.IO.Path.GetFileName(typeof(Microsoft.VisualStudio.TextTemplating.VSHost.ModelingTextTransformation).Assembly.Location));
