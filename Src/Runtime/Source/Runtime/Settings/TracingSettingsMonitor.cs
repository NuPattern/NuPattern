...
namespace NuPattern.Runtime
{
	...
	/// </summary>
	public class TracingSettingsMonitor : IDisposable
	{
		...
		private static bool HasSettings(RuntimeSettings settings)
		{
			return settings != null && settings.Tracing != null;
		}

		private static void ApplySettings(RuntimeSettings settings)
		{
		...
		private static void ClearSettings(RuntimeSettings settings)
		{
