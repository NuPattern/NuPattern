...
namespace Microsoft.VisualStudio.Patterning.Runtime.Schema
{
	...
	/// </remarks>
	public partial class PatternModelHelpKeywordHelper : PatternModelHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PatternModelHelpKeywordHelper.
		/// </summary>
		protected PatternModelHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PatternModelHelpKeywordHelper.
		/// </summary>
		public static PatternModelHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PatternModelHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PatternModelHelpKeywordHelperBase.
		/// </summary>
		protected PatternModelHelpKeywordHelperBase()
			: base() { }
