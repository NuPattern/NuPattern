...
namespace Microsoft.VisualStudio.Patterning.Runtime.Schema
{
	...
	/// </summary>
	[CLSCompliant(false)]
	public partial class Adapter : StandardModelingAdapter, IModelingAdapterWithStore, IModelingAdapterWithRootedModel
	{
		/// <summary>
		/// Identifier for the runtime state adapter.
		/// </summary>
        public const string AdapterId = "Microsoft.VisualStudio.Patterning.Runtime.Schema";
