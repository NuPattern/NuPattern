...
namespace Microsoft.VisualStudio.Patterning.Runtime.Schema
{
	...
	public partial class ExtensionPointShapeBase
	{
		...
		/// </summary>
		private static IList FilterElementsFromExtensionPointSchemaForProperties(LinkedElementCollection<PropertySchema> result)
		{
			return ShapeExtensions.FilterElementsFromCompartment<PropertySchema, string>(result, (item => true), item => item.Name);
		}
	}
