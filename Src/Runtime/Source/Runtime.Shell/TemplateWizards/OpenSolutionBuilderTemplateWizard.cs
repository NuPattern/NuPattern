...
namespace NuPattern.Runtime.Shell
{
	...
	[CLSCompliant(false)]
	public class OpenSolutionBuilderTemplateWizard : Extensibility.TemplateWizard
	{
		private static readonly ITraceSource tracer = Tracer.GetSourceFor<OpenSolutionBuilderTemplateWizard>();
