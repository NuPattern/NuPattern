...
namespace Microsoft.VisualStudio.Patterning.Runtime
{
	...
	/// </summary>
	/// <typeparam name="TInterface">The type of the strong-typed interface for the product.</typeparam>
	[CLSCompliant(false)]
	public interface IProductProxy<TInterface> : IPropertyProxy<TInterface>, IFluentInterface
	{
		...
		TView GetView<TView>(Expression<Func<TView>> propertyExpression, Func<IView, TView> viewProxyFactory);
	}
}